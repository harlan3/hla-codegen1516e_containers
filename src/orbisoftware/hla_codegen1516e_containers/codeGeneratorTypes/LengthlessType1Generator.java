...
public class LengthlessType1Generator {
	...
	public LengthlessType1Generator(LedgerEntry ledgerEntry) {
	...
	public void printHeader(String elementClassname, ElementType elementType, LedgerEntry value) {
		...
		if (elementType == ElementType.Object) {
			System.out.println("package " + Utilities.packageRoot + "Objects." + elementClassname + ".LengthlessArrays;");
			elementReference = "Objects";
		} else {
			System.out.println("package " + Utilities.packageRoot + "Interactions." + elementClassname + ".LengthlessArrays;");
	...
	public void generateClass(LedgerEntry ledgerEntry) {
		...
		System.out.println(indentFormat + "public " + primitiveClass + "[] value = new " + primitiveClass +
				"[" + 1 + "];");
		System.out.println();
