...
import orbisoftware.hla_codegen1516e_containers.codeGeneratorTypes.EnumeratedTypeGenerator;
...
public class MainApplication {
	...
	private static void printUsage() {
		...
		System.out.println("Usage: HlaCodeGen1516e_classes [OPTION]...");
	...
	public static void main(String[] args) {
		...
		hlaPathBuilder.generateDatabase(fomFilename, elementModel, "Cont", linesValueBool, false);
